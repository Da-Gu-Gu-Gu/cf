...
const Privacy = () => {
  return (
    <div style={{background:'white',paddingTop:'60px'}}>
        <Container maxW={`container.lg`}>
        <h1>Privacy Policy</h1>
<p>Your privacy is important to us. It is Crush_Hook&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://crushhook.herokuapp.com/">https://crushhook.herokuapp.com/</a>, and other sites we own and operate. </p>
<p>This policy is effective as of 13 February 2022 and was last updated on 13 February 2022. </p>
